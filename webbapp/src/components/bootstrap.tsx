    ...
    return (
      ...
      <main role="main">
        ...
        <section className="jumbotron text-center">
          <div className="container">
            <h1 className="jumbotron-heading">Städfirma</h1>
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-md-4">
                ...
                <img className="card-img-top" data-src="nedladdning.jpeg" alt="Thumbnail [100%x225]" src="nedladdning.jpeg" data-holder-rendered="true"></img>
